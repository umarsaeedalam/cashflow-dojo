...
function NavBar() {
    ...
    return (
        ...
        <nav className={"col-start-1 col-end-2 row-start-1 row-end-3 flex flex-col h-full"}>
            ...
            <ul className={"grow ml-4 max-[1400px]:ml-5 mr-7 max-[1400px]:mr-0 flex flex-col mt-10 mb-8 gap-3 font-semibold"}>
                <li className={"flex gap-4 items-center relative"}>
                    ...
                    <Link href="/dashboard" className={`rounded-lg focus:outline-none ${pathname === '/dashboard' ? 'focus-visible:outline-dark-700': 'focus-visible:outline-accent-500'} relative z-10`}>
                        <div className={`mt-auto rounded-lg flex gap-3 items-center ${pathname === '/dashboard' ? 'text-light-50': 'text-dark-700 bg-transparent border-transparent hover:bg-accent-300 hover:text-light-100'} py-3 pl-4 pr-16 max-[1400px]:p-3 transition-colors ease-in-out duration-200`}>
                            <TbLayoutDashboardFilled className={"text-2xl"}/>
                ...
                <li className={"flex gap-4 items-center relative"}>
                    {pathname === '/dashboard/expenses' && <motion.div layoutId="nav" className="bg-accent-500 block absolute inset-0 rounded-lg" />}
                    
                    <Link href="/dashboard/expenses" className={`focus:outline-none rounded-lg ${pathname === '/dashboard/expenses' ? 'focus-visible:outline-dark-700': 'focus-visible:outline-accent-500'} relative z-10`}>
                        <div className={`mt-auto flex rounded-lg gap-3 items-center ${pathname === '/dashboard/expenses' ? 'text-light-50': 'text-dark-700 bg-transparent border-transparent hover:bg-accent-300 hover:text-light-100'} py-3 pl-4 pr-16 max-[1400px]:p-3 transition-colors ease-in-out duration-200`}>
                            <FaMoneyBillTransfer className={"text-2xl"}/>
                ...
                <li className={"flex gap-4 items-center relative"}>
                    ...
                    <Link href="/dashboard/analytics" className={`focus:outline-none rounded-lg ${pathname === '/dashboard/analytics' ? 'focus-visible:outline-dark-700': 'focus-visible:outline-accent-500'} relative z-10`}>
                        <div className={`mt-auto rounded-lg flex gap-3 items-center ${pathname === '/dashboard/analytics' ? 'text-light-50 bg-accent-500 border-accent-500' : 'text-dark-700 bg-transparent border-transparent hover:bg-accent-300 hover:text-light-100'} py-3 pl-4 pr-16 max-[1400px]:p-3 transition-colors ease-in-out duration-200`}>
                            <MdAnalytics className={"text-2xl"}/>
