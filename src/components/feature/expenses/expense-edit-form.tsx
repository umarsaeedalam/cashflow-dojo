            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="grid gap-4 py-4">
                <FormField control={form.control} name="description" render={({ field }) => (
                    <FormItem className="grid grid-cols-4 items-center gap-x-4 gap-y-1">
                        ...
                        <div className="col-span-3 max-[400px]:col-span-4 space-y-1">
                            <FormControl>
                                <Input placeholder="Enter expense description" {...field} className="border border-secondary text-secondary rounded-md placeholder:text-secondary focus:!outline-none" />
                            </FormControl>
                ...
                <FormField control={form.control} name="amount" render={({ field }) => (
                    <FormItem className="grid grid-cols-4 items-center gap-x-4 gap-y-1">
                        ...
                        <div className="col-span-3 max-[400px]:col-span-4 space-y-1">
                            <FormControl>
                                <Input type="number" placeholder="Enter amount" {...field} className="border border-secondary text-secondary rounded-md max-[500px]:text-sm placeholder:text-secondary focus:!outline-none" />
                            </FormControl>
                ...
                <FormField control={form.control} name="date" render={({ field }) => (
                    <FormItem className="grid grid-cols-4 items-center gap-x-4 gap-y-1">
                        ...
                        <div className="col-span-3 max-[400px]:col-span-4 space-y-1">
                            <Popover>
                                <PopoverTrigger asChild className="!font-normal border bg-primary border-secondary text-secondary rounded-md placeholder:text-secondary/50 focus:!outline-none">
                                    <FormControl>
                    ...
                    <FormItem className="grid grid-cols-4 items-center gap-x-4 gap-y-1">
                        ...
                        <div className="col-span-3 max-[400px]:col-span-4 space-y-1">
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <FormControl>
                                    <SelectTrigger className="border-secondary border text-secondary rounded-md focus:outline-none transition-colors ease-in-out duration-00">
                ...
                <div className="flex justify-end">
                    <Button type="submit" disabled={isPending} className="bg-accent font-semibold text-primary border rounded-lg mt-2 text-right border-accent hover:bg-accent-shade hover:border-accent-shade !outline-none focus-visible:!outline-secondary transition-all ease-in duration-200 transform active:scale-90">
