    ...
    return (
        <div className="flex h-full items-center max-[550px]:justify-center">
            <div className="flex mx-24 gap-20 max-[1340px]:flex-col max-[1340px]:gap-10 max-[1340px]:mx-16 max-[mx-0]:">
                ...
                <div className="max-w-md font-semibold text-primary border-secondary border-2 max-[550px]:bg-primary py-16 max-[1340px]:py-12 max-[700px]:py-8 px-8 max-[700px]:px-5 max-[550px]:px-4 rounded-xl flex flex-col items-center max-[550px]:border-primary max-[1340px]:self-center">
